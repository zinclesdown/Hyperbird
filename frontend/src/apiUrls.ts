export default {
  ...
  getTmdbTvSeriesMetadataByUnit: 'http://0.0.0.0:8000/api/get_tmdb_tv_series_metadata_by_unit', // 获取某个媒体单元的 TMDB 信息
  //get_tmdb_tv_episode_metadata_by_unit
  getTmdbTvEpisodeMetadataByUnit: 'http://0.0.0.0:8000/api/get_tmdb_tv_episode_metadata_by_unit', // 获取某个媒体单元的 TMDB 信息

...
export const apiUrlStorage = defineStore('apiUrls', {
  state: () => ({
    ...
    getTmdbTvSeriesMetadataByUnit: 'http://0.0.0.0:8000/api/get_tmdb_tv_series_metadata_by_unit',
    getTmdbTvEpisodeMetadataByUnit: 'http://0.0.0.0:8000/api/get_tmdb_tv_episode_metadata_by_unit',
  }),
});
